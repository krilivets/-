...
#  НАСТРОЙКА
# ============================================================
# Лучше всего для хостинга указать BOT_TOKEN в переменных окружения.
# Например на Render/Railway/VPS:
# BOT_TOKEN=твой_токен_от_BotFather
#
# Также можно временно вставить токен прямо сюда, но для хостинга безопаснее env.
...
async def video_handler(message: Message, bot: Bot):
    ...
    # Если нужен приём больших видео, лучше поднимать Local Bot API Server.
    ...
    try:
        ...
        await status_message.edit_text(
            "❌ Не найден ffmpeg.\n\n"
            "На хостинге нужно установить ffmpeg.\n"
            "Если запускаешь через Dockerfile из архива — ffmpeg уже ставится автоматически."
        )
